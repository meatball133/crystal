...
describe Lasagna do
  ...
  describe "preparation_time_in_minutes" do
    it "1 layer should return 2" do
      Lasagna.preparation_time_in_minutes(1).should eq(2)
    end
    it "2 layers should return 4" do
      Lasagna.preparation_time_in_minutes(2).should eq(4)
    end
    it "4 layers should return 8" do
      Lasagna.preparation_time_in_minutes(4).should eq(8)
    end
  end

  describe "total_time_in_minutes" do
    it "1 layer, 30 minutes in oven should return 32" do
      Lasagna.total_time_in_minutes(1, 30).should eq(32)
    end
